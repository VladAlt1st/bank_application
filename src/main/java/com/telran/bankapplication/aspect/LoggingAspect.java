package com.telran.bankapplication.aspect;
...
public class LoggingAspect {
    @Pointcut("execution(public * com.telran.bankapplication.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.telran.bankapplication.service.*.*(..))")
